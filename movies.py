...
st.markdown("## Welcome on Movies Search and Recommendation 🔍 🎬 🍿 ")

# model_name: str = 'multilingual-2210-alpha'
model_name: str = 'multilingual-22-12'
COHERE_API_KEY='aZsfSTt2FBwBh6adJJxulTf3FKyrfb6KOzNooaXV'
#COHERE_API_KEY = os.environ.get("aZsfSTt2FBwBh6adJJxulTf3FKyrfb6KOzNooaXV")
